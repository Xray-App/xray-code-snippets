...
# obtain the TP issue id from the given Test Plan key, as issue ids are not visible to users
result = client.execute(query)
testplan_id = result['getTestPlans']['results'][0]['issueId']
    ...
    getTestPlan(issueId: "%s") {
        ...
        tests(limit: 100) {
          ...
          results {
            ...
            status(isFinal: true, testPlan: "%s") {
              name
            }
