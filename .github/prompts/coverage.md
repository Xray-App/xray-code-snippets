...
description: 'Show requirement coverage based on Xray'
---
Your goal is to show a very brief overall coverage overview for a given project, or current sprint in a project and/or a version.
